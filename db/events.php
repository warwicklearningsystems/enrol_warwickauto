...
$supportedmods = \enrol_warwickauto\helper::get_mods_with_viewed_event();
foreach ($supportedmods as $modname) {
    $observers[] = array(
        'eventname'   => '\mod_'.$modname.'\event\course_module_viewed',
        'callback'    => '\enrol_warwickauto\observer::course_module_viewed'
    );
}

$observers[] = array(
    'eventname'   => '\core\event\user_loggedin',
    'callback'    => '\enrol_warwickauto\observer::user_loggedin'
);

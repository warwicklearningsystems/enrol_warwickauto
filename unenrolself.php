...
$instance = $DB->get_record('enrol', array('id' => $enrolid, 'enrol' => 'warwickauto'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/warwickauto/unenrolself.php', array('enrolid' => $instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_warwickauto', format_string($course->fullname));

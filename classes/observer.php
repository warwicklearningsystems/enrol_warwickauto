...
/**
 * Event observer for enrol_warwickauto.
 */
class observer {
    ...
    public static function course_module_viewed($event) {
        ...
        if ($instance->customint3 != ENROL_WARWICKAUTO_MOD_VIEWED || empty($instance->customtext2)) {
    ...
    public static function schedule_welcome_email($instance, $userid) {
        ...
        $emailtask = new \enrol_warwickauto\task\course_welcome_email();
        // add custom data
